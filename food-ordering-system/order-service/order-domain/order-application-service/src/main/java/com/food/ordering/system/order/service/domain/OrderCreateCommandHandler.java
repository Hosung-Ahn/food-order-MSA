...
public class OrderCreateCommandHandler {
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand) {
        ...
        Order resultOrder = saveOrder(order);
        log.info("Order created successfully with id: {}", resultOrder.getId());
        return orderDataMapper.orderToCreateOrderResponse(resultOrder);
    }
    ...
    public Order saveOrder(Order order) {
        ...
        if (result == null) {
            log.error("Order not saved successfully");
            throw new OrderDomainException("Order not saved successfully");
        }
        log.info("Order saved successfully with id: {}", result.getId());
        return result;
    }
}
